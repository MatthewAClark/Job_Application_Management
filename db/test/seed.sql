...
INSERT INTO companies
    (company_name)
VALUES('Devon County Council'),('Plumbing Company'),('PPP Taking Care'),('Met Office');
...
INSERT INTO position_contacts(contact_id, position_id)
    VALUES(1,1),(null,2),(null,3),(null,4),(null,5),(null,6),(null,7);

INSERT INTO adverts(position_id, position_contact_id, advert_ref, contract_type, full_time_part_time, date_posted, date_seen, closing_date, live, advert_url, min_salary, max_salary, advert_description, agency, job_board, voluntary, job_location, applied)
...
INSERT INTO skills(skill_name, description_long, description_short)
VALUES('Customer Service','Proven ability to handle all customer and support requests in a professional and timely manner from first cobntact through to a satisfactory completion or resolution\nRecent experience working in blah de blah de blah',''),('Teamwork','Previous roles working in teams include blah de blah de blah',''),('Javascript','Developed on bootcamp courses and in spare time on my own projects such as this one',''),('NodeJS','2 years experience in this too',''),('Administration','Proven experience working for years in NHS filing and prepping notes','');

INSERT INTO advert_experience(skill_id, advert_id, essential, duration, experience_description)
