...
(
    position_contact_id SERIAL PRIMARY KEY,
    contact_id INT,
    position_id INT,
...
(
    ...
    applied BOOLEAN,
    FOREIGN KEY (position_id) REFERENCES positions(position_id),
    FOREIGN KEY (position_contact_id) REFERENCES position_contacts(position_contact_id)
);
...
--     (contact_id, contact_method, contact_value)
...
VALUES('finance', ''),
    ('administration', 'A fine member of the administration team, I would make an excellent candidate'),
    ('Marketing', ''),
    ('Scientist', ''),
...
INSERT INTO position_contacts
    (contact_id, position_id)
VALUES(1, 1),
    (null, 2),
    (null, 3),
    (null, 4),
