...
(
    advert_contact_id SERIAL PRIMARY KEY,
    contact_id INT,
    advert_id INT,
    FOREIGN KEY (contact_id) REFERENCES contacts(contact_id),
...
INSERT INTO adverts
    ...
    (occupation_id, company_id, address_id, position_title, advert_ref, contract_type, contract_hours, date_posted, date_seen, closing_date, live, advert_url, min_salary, max_salary, advert_description, agency, job_board, voluntary, job_location)
VALUES(
...
INSERT INTO applications
    (address_id, company_id, advert_id)
VALUES(1, 1, 1), (2, 2, 2), (3, 3, 3), (4, 4, 4), (4, 4, 5),(4, 4, 6), (4, 4, 7);
