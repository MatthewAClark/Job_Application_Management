...
const getContactValuesById = (contact_id) => db.manyOrNone('SELECT * FROM contacts RIGHT JOIN contact_values ON contacts.contact_id=contact_values.contact_id WHERE contacts.contact_id = $1',[contact_id])
