...
const getContactValuesById = (contact_id) => db.manyOrNone('SELECT * FROM contacts FULL JOIN contact_values ON contacts.contact_id=contact_values.contact_id',[contact_id])
...
module.exports = {getContactValues, getContactById, getAllContacts, getContactValuesById, getContactsByCompanyId, postNewContact, getContactsByAddressId, getContactsByCompanyAndAddressId, postContactValue};