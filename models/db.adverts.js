...
const getAllAdvertsRaw = () => db.manyOrNone('SELECT * FROM adverts');  
...
module.exports = {getAllAdvertsRaw, seedNewAdvert, postNewAdvert, getAllAdverts, getLiveAdverts, getAdvertById, putAdvertById};