...
const seedNewAddress = (address_id, company_id, address_field, postcode, live) => db.one('INSERT INTO addresses (address_id, company_id, address_field, postcode, live) VALUES ($1, $2, $3, $4, $5) RETURNING *', [address_id, company_id, address_field, postcode, live]);
...
const putAddressById = (address_id, company_id, address_field, postcode, live) => db.one('UPDATE addresses SET company_id=$1, address_field=$2, postcode=$3, live=$4 WHERE address_id=$5 RETURNING *',[company_id, address_field, postcode, live, address_id]);
...
module.exports = {seedNewAddress, getAddressById, postNewAddress, getLiveAddressesByCompanyId, getAllAddresses, putAddressById};